        ...
        @auth
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active d-flex align-items-center gap-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              {{-- Avatar Logika: Foto Unggahan vs Inisial --}}
              <div class="rounded-circle overflow-hidden d-flex align-items-center justify-content-center shadow-sm" style="width: 35px; height: 35px; border: 2px solid rgba(255,255,255,0.2);">
                @if(auth()->user()->image)
                    {{-- Menampilkan foto yang diunggah ke storage --}}
                ...
                @else
                    ...
                    <div class="bg-primary text-white w-100 h-100 d-flex align-items-center justify-content-center" style="font-size: 0.85rem; font-weight: bold;">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 mt-2 animate-slide">
              ...
              <li>
                  <a class="dropdown-item py-2" href="/dashboard/profile">
              ...
              <li>
                <form action="/logout" method="post">
                  @csrf
                  <button type="submit" class="dropdown-item py-2 text-danger fw-medium border-0 bg-transparent w-100 text-start">
