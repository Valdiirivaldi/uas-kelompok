...
<div class="row align-items-center min-vh-75 py-5">
    ...
    <div class="col-lg-6 order-2 order-lg-1">
        ...
        <p class="lead text-secondary mb-4">
            ...
            Jelajahi berbagai artikel menarik yang telah kami siapkan untukmu.
        </p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            <a href="/posts" class="btn btn-primary btn-lg px-4 me-md-2 rounded-pill shadow-sm fw-bold">
                <i class="bi bi-book-half me-2"></i> Mulai Membaca
            </a>
            <a href="/about" class="btn btn-outline-secondary btn-lg px-4 rounded-pill fw-bold">
                Tentang Kami
            </a>
        </div>
    </div>
    
    {{-- Gambar Ilustrasi (Ambil dari Unsplash: Technology) --}}
    <div class="col-lg-6 order-1 order-lg-2 mb-5 mb-lg-0 text-center">
        <img src="https://source.unsplash.com/800x600/?technology,laptop" 
             alt="Hero Image" 
...
<div class="row mt-5 pt-5 border-top">
    <div class="col-md-4 text-center mb-4">
        ...
        <p class="text-muted">Tutorial koding terlengkap mulai dari Laravel, Bootstrap, hingga JavaScript.</p>
    </div>
    <div class="col-md-4 text-center mb-4">
        ...
        <p class="text-muted">Cara-cara efektif untuk meningkatkan produktivitas dan skill digitalmu.</p>
    </div>
    <div class="col-md-4 text-center mb-4">
        ...
        <p class="text-muted">Bergabung dengan komunitas pembaca yang antusias dan saling berbagi.</p>
    </div>
</div>
@endsection